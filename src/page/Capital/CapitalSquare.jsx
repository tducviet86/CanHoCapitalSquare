...
//       style={{
//         backgroundImage:
//           "url('https://capitalsquare.vn/wp-content/themes/capitalsquare/dist/images/section-6-bg.png')",
//       }}
//     >
...
//         <div
//           id="custom-prev"
//           className="absolute left-0 top-1/2 z-10 -translate-y-1/2 bg-white text-blue-600 p-3 rounded-full shadow-md cursor-pointer hover:bg-gray-100 transition"
//         >
...
//         <div
//           id="custom-next"
//           className="absolute right-0 top-1/2 z-10 -translate-y-1/2 bg-white text-blue-600 p-3 rounded-full shadow-md cursor-pointer hover:bg-gray-100 transition"
//         >
...
//               <div className="rounded-2xl overflow-hidden shadow-lg group transition duration-300 hover:shadow-xl relative cursor-pointer">
//                 <img
//                   src={item.img}
//                   alt={item.title}
  ...
  return (
    ...
    >
      <div className="container mx-auto">
        ...
        <div className="relative mt-90 mb-15">
          {/* Custom Arrows - Fixed positioning and styling */}
          <div
            id="custom-prev"
          ...
          >
            {slides.map((item) => (
              <SwiperSlide key={item.id}>
                <div className="rounded-2xl overflow-hidden  group transition-all duration-500  relative cursor-pointer ">
                  <img
                    src={item.img}
                    alt={item.title}
